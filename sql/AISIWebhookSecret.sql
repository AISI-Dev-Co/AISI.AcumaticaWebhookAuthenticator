...
-- For development databases; the customization package's Sql item creates it on publish.
--
...
IF OBJECT_ID('dbo.AISIWebhookSecret') IS NULL
...
-- Upgrade from 0.2.0. NULL reads as UTF-8, the previous behaviour.
